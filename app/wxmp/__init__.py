...
bp = Blueprint('mminimall',__name__)

#微信小程序API#
@bp.route('/home/navbar',methods=['GET'])
def get_navbar():
    return jsonify({
        "code": 100,
        "message": "查询成功",
...
@bp.route('/home/banners',methods=['GET'])
def get_banners():
    return jsonify({
        "code": 100,
        "message": "查询成功",
        "result": [
            ...
            "id": 1,
            "bannerName": "全新上市",
            "imgUrl": "https://m.360buyimg.com/mobilecms/s750x366_jfs/t1/34869/14/3703/113972/5cb953c1E4294d8ea/b73c538710f5c462.jpg!cr_1125x549_0_72!q70.jpg.dpg",
            "clickUrl": "",
            "seq": 1
        },
        {
        ...
        },
        {
            "id": 4,
            "bannerName": "口红",
            "imgUrl": "https://m.360buyimg.com/mobilecms/s750x366_jfs/t30721/304/509713251/35851/6a4e498c/5bf5630dNb99e150f.jpg!cr_1125x549_0_72!q70.jpg.dpg",
            "clickUrl": None,
            "seq": 4
        }
        ]
...
@bp.route('/home/menus',methods=['GET'])
def get_menus():
    return jsonify({
        "code": 100,
        "message": "查询成功",
...
@bp.route('/activity/brands',methods=['GET'])
def get_brands():
    return jsonify({
            "code": 100,
            "message": "查询成功",
...
@bp.route('/goods/getHotGoodsList',methods=['GET'])
def get_hot_goods():
